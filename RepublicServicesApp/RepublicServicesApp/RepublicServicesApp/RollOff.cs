...
{
    public partial class RollOff : Form
    {
        public RollOff()
        {
            InitializeComponent();
        ...
        private void rollOffBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
            this.rollOffBindingSource.EndEdit();
            this.tableAdapterManager.UpdateAll(this.republicServicesDataSet);

        }

        private void RollOff_Load(object sender, EventArgs e)
        {
            try
            {
                // TODO: This line of code loads data into the 'republicServicesDataSet.RollOff' table. You can move, or remove it, as needed.
                this.rollOffTableAdapter.Fill(this.republicServicesDataSet.RollOff);
            }
            catch (Exception ex)
            {
        ...
        private void rollOffDataGridView_DataError(object sender, DataGridViewDataErrorEventArgs e)
        {
